...
# define ERR_NICKNAMEISUSE(nick) ("433 NICK " + std::string(nick) + " :is already in use\r\n")
...
# define RPL_TOPIC_BIS(nick, channel, topic) ("332 " + std::string(nick) + " " + std::string(channel) + " :" + std::string(topic) + "\r\n")
...
//Messages USER
# define RPL_AWAY(sender, nick) (":" + std::string(SERVER_NAME) +" 301 " + std::string(sender) + " " + std::string(nick) + " :This user is disconnected.\r\n")
# define RPL_ENDOFNAMES(nick, chan) (":" + std::string(SERVER_NAME) + " 366 " + nick + " " + chan + " :End of NAMES list\r\n").c_str()
# define RPL_TRACEOPERATOR(operator_nick) (":" + std::string(SERVER_NAME) + " 313 " + operator_nick + " :is an IRC operator\r\n")
